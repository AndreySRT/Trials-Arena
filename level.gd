...
func morning_state ():
	...
	tween.tween_property(light, "energy", 0.2, 60)
	var tween1 = get_tree().create_tween()
	tween1.tween_property(pointLight, "energy", 0, 60)

func evening_state ():
	var tween = get_tree().create_tween()
	tween.tween_property(light, "energy", 0.95, 60)
	var tween1 = get_tree().create_tween()
	tween1.tween_property(pointLight, "energy", 1.5, 60)
